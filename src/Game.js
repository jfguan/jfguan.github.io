    ...
    <div className="App">
      ...
      <div className="Header">
        ...
        <div className="IconBox">
          <AiOutlineInfoCircle onClick={() => setIsAboutModalOpen(true)} />
          <AiOutlineQuestionCircle onClick={() => setIsHelpModalOpen(true)} />
        </div>
      </div>
      <GameBox seconds={seconds} score={score} />
      <div className="mathBox">
        <InputBox currentGuess={currentGuess} />
        <div className="EquationOutput">{currentOutput}</div>
      </div>
      <Keyboard
        puzzle={puzzle}
      ...
      />
      <HelpModal isOpen={isHelpModalOpen} handleClose={closeHelpModal} />
      <WinModal
