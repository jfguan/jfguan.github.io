    ...
    <Modal show={isOpen} onHide={handleClose} className="modal">
      <Modal.Body>
        <div className="modalHeader">
          <div className="modalTitle">Time's up! You solved:</div>
          <IoMdClose className="modalCloseButton" onClick={handleClose} />
        </div>
        <div className="scoreText">{score} puzzles</div>
        <div className="successBox">
          ...
          <div className="buttonBox">
            <Button
              variant="success"
              className="linkButton shareButton"
              onClick={() => {
            ...
            <Button
              variant="primary"
              className="linkButton websiteButton"
              onClick={() => {
                shareWebsite();
                handleShare();
              }}
