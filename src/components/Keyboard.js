    ...
    <div className="keyboard">
      ...
      <div className="operatorKeyboard">
        <Key
          value="+"
          onValueInput={onValueInput}
          classes={classnames('operatorKey num1')}
        />
        <Key
          value="-"
          onValueInput={onValueInput}
          classes={classnames('operatorKey num2')}
        />
        <Key
          value="*"
          onValueInput={onValueInput}
          classes={classnames('operatorKey num3')}
        />
        <Key
          value="/"
          onValueInput={onValueInput}
          classes={classnames('operatorKey num4')}
        />
        <Key
          value="("
          onValueInput={onValueInput}
          classes={classnames('operatorKey num5')}
        />
        <Key
          value=")"
          onValueInput={onValueInput}
      ...
      <div className="modifierKeys">
        <Key
          value="Enter"
          onValueInput={onValueInput}
          classes={classnames('modifierKey')}
        />
        <Key
          value="Delete"
          onValueInput={onValueInput}
