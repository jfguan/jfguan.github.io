...
const HabitGambling = () => {
  ...
  return (
    <div className="HabitBox">
      ...
      <div className="HabitBox-title">Habit Gambling</div>
      {!isSignedIn && (
        <StyledFirebaseAuth
          uiConfig={uiConfig}
      ...
      <div className="HabitBox-total">
        ...
        <div className="HabitBox-refresh">
          <img
            ...
            alt="Refresh icon"
            onClick={retrieveTotal}
          />
        </div>
      </div>
      <div className="HabitBox-multiplier">Multiplier - {multiplier}x</div>
      <div className="HabitBox-quick-button">
        <div
          className="HabitBox-quick-button-border"
          onClick={() => addToTotal(0.05)}
        >
          $0.05
        </div>
      </div>
      ...
      <div className="HabitBox-custom-button">
        ...
        />
        <div className="HabitBox-custom-trigger" onClick={AddToTotalCustomRoll}>
          Roll custom
        </div>
      </div>
      <div className="HabitBox-custom-button">
